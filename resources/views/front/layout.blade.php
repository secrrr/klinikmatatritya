...
<head>
    ...
    <style>
    .hero { background: linear-gradient(90deg, #0d6efd33, #6c757d11); padding:60px 0 }
    .service-card img{ max-height:180px; object-fit:cover }
    footer{ background:#f8f9fa; padding:30px 0; margin-top:40px }
    </style>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
  <div class="container">
    <a class="navbar-brand" href="{{ route('home') }}"><img src="https://via.placeholder.com/180x50?text=Klinik+Mata" alt="logo"></a>
