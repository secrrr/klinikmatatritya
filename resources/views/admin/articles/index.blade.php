        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-4">{{ $loop->iteration + ($articles->currentPage() - 1) * $articles->perPage() }}</td>
                        <td>
                            @if($article->image)
                                <img src="{{ asset('storage/' . $article->image) }}" alt="Thumbnail" class="rounded" width="60" height="40" style="object-fit: cover;">
                            @else
                        ...
                        <td>
                            ...
                            <div class="small text-muted text-truncate" style="max-width: 300px;">{{ $article->excerpt }}</div>
                        </td>
                        <td>
                        ...
                        <td class="pe-4 text-end">
                            <a href="{{ route('admin.articles.edit', $article->id) }}" class="btn btn-sm btn-light text-primary me-1"><i class="fas fa-edit"></i></a>
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5 text-muted">
                            <i class="fas fa-newspaper fs-1 mb-3 d-block"></i>
