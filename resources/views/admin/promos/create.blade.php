<!-- filepath: d:\Freelance\klinikmatatritya\resources\views\admin\promos\create.blade.php -->
                ...
                <form action="{{ route('admin.promos.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text small">Upload gambar baru atau pilih dari Media Library.</div>
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
